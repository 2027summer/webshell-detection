...
inline bool is_execve_bin_sh_cat_flag(const MatchState& state, const SyscallEvent& event) {
...
inline bool is_openat_flag(const MatchState& state, const SyscallEvent& event) {
